...
export default function CBTEngineClient({ examId, initialExam, initialQuestions, studentProfile }: { examId: string, initialExam: any, initialQuestions: any[], studentProfile: any }) {
