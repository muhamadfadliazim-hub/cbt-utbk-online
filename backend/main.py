...
def startup_event():
    ...
    db = SessionLocal()
    # MIGRATION SAFETY
    try: db.execute(text("ALTER TABLE questions ADD COLUMN stats_correct INTEGER DEFAULT 0")); db.commit()
    except: pass
