...
const App = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (res.ok) { 
                // V50: Data user sekarang mengandung 'group' dan 'role' yang valid
                setUser(data); 
                localStorage.setItem('eduprime_user', JSON.stringify(data)); 
            } else { 
                setError(data.detail || "Identitas tidak ditemukan."); 
            }
        } catch (err) { 
    ...
    // TAMPILAN LOGIN V50 (ELEGANT LIGHT THEME)
    return (
