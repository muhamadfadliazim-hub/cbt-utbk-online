        ...
        {showDetailModal && selectedStudentDetail && (
            <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl flex flex-col h-[70vh]">
                    <div className="p-4 border-b flex justify-between items-center bg-gray-50 rounded-t-xl">
                        <div><h3 className="text-lg font-bold text-indigo-900">Rincian Jawaban Salah</h3><p className="text-sm text-gray-500">{selectedStudentDetail.full_name} ({selectedStudentDetail.username})</p></div><button onClick={()=>setShowDetailModal(false)}><X/></button>
                    </div>
