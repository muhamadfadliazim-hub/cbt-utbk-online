            ...
            <div>
                ...
                <div className="bg-white p-6 rounded shadow mb-6 border-l-4 border-indigo-500">
                    ...
                    <div className="flex gap-2 items-end">
                        ...
                        <div className="w-32"><label className="text-xs font-bold text-gray-500">PG</label><input type="number" className="w-full p-2 border rounded" placeholder="650" value={newMajor.passing_grade} onChange={e=>setNewMajor({...newMajor, passing_grade:e.target.value})}/></div>
